...
This is a python script to test the Depth first search class

The script generates a graphs which is a discrete representation of a domain
with both x and y axis varying -20 to 20. DFS is performed on this graph from
a start node
"""
import graphs
...
traverse = dfs(graph, startnodenumber)
# print traverse
...
# ani.save('DFS_animation.mp4', fps=20, writer="avconv", codec="libx264")
plt.show()
