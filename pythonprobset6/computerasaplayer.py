...
def playhand(hand,word_list,totalscore,totaltime,timelimit,enteredword,dicc):
    ...
    if word==".":
        ...
        if len(hand)==1:
            ...
            return playhand(hand,word_list,totalscore,totaltime,timelimit,enteredword,dicc)
...
def playgame(word_list,locdict):
    ...
    while True:
        ...
        if cmd == 'n':
            ...
            totscore=playhand(hand.copy(), word_list,totalscore,totaltime,timelimit,enteredword,dicc)
            print(totscore)
        elif cmd == 'r':
            totscore=playhand(hand.copy(), word_list,totalscore,totaltime,timelimit,enteredword,dicc)
            print(totscore)
